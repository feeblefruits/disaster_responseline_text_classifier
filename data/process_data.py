...
def clean_values(value):
    ...
    '''
    Simple function to return input string's last
    character and returns as int
    '''
    return int(value[-1])
...
def clean_data(df):
    ...
    for i in list(categories.loc[0]):
    ...
    for column in categories:
        categories[column] = categories[column].apply(clean_values)
